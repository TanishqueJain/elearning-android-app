...
public class TestChapterActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.menu_setting:
                        Intent intent = new Intent(TestChapterActivity.this, SettingActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),SettingActivity.class));
                    ...
                    case R.id.menu_home:
                        ...
                        Intent intent2 = new Intent(TestChapterActivity.this, HomeActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),HomeActivity.class));
                    ...
                    case R.id.menu_test:
                        Intent intent3 = new Intent(TestChapterActivity.this, TestActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),TestActivity.class));
                    ...
                    case R.id.menu_logout:
                        ...
                        Intent intent4 = new Intent(TestChapterActivity.this, MainActivity.class);
        ...
        SubjectReportList = findViewById(R.id.test_chapter_list_recycler_view);
...
//        linearLayoutManager.setStackFromEnd(true);
        ...
        ClassListRef= FirebaseDatabase.getInstance().getReference().child("Test").child("Class").child(classID).child("Subject").child(subjectID).child("Chapter");

        classnameET=(EditText) findViewById(R.id.admin_test_chapter_name_edittext);


        addclassbtn=(Button) findViewById(R.id.admin_test_chapter_add_btn);
...
//        addclassbtn.setVisibility(View.VISIBLE);
        ...
        addclassbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(TestChapterActivity.this, "Please Enter Name", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    classRef.child(classID).child("Subject").child(subjectID).child("Chapter").child(classnameET.getText().toString()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            {
                                Toast.makeText(TestChapterActivity.this, "Already Exists", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                ...
                                classRef.child(classID).child("Subject").child(subjectID).child("Chapter").child(classnameET.getText().toString()).updateChildren(FakeMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(TestChapterActivity.this, "Successfully Created", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    ...
                    protected void onBindViewHolder(@NonNull SubjectListViewHolder holder, int position, @NonNull final Chapter model) {
                        holder.subjectname.setText(model.getChaptername());
                            ...
                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent = new Intent(TestChapterActivity.this, TestSeriesActivity.class);
