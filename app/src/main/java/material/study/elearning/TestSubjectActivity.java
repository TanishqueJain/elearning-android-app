            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.menu_setting:
                        Intent intent = new Intent(TestSubjectActivity.this, SettingActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),SettingActivity.class));
                    ...
                    case R.id.menu_home:
                        ...
                        Intent intent2 = new Intent(TestSubjectActivity.this, HomeActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),HomeActivity.class));
                    ...
                    case R.id.menu_test:
                        Intent intent3 = new Intent(TestSubjectActivity.this, TestActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(),TestActivity.class));
                    ...
                    case R.id.menu_logout:
                        ...
                        Intent intent4 = new Intent(TestSubjectActivity.this, MainActivity.class);
        ...
        SubjectReportList = findViewById(R.id.admin_test_subject_list_recycler_view);
...
//        linearLayoutManager.setStackFromEnd(true);
        ...
        ClassListRef= FirebaseDatabase.getInstance().getReference().child("Test").child("Class").child(classID).child("Subject");

        classnameET=(EditText) findViewById(R.id.admin_test_subject_name_edittext);


        addclassbtn=(Button) findViewById(R.id.admin_test_subject_add_btn);
...
//        addclassbtn.setVisibility(View.VISIBLE);
        ...
        addclassbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(TestSubjectActivity.this, "Please Enter Name", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    classRef.child(classID).child("Subject").child(classnameET.getText().toString()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            {
                                Toast.makeText(TestSubjectActivity.this, "Already Exists", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                ...
                                classRef.child(classID).child("Subject").child(classnameET.getText().toString()).updateChildren(FakeMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(TestSubjectActivity.this, "Successfully Created", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                ...
                new FirebaseRecyclerAdapter<Subjects, SubjectListViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull SubjectListViewHolder holder, int position, @NonNull final Subjects model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(TestSubjectActivity.this, TestChapterActivity.class);
